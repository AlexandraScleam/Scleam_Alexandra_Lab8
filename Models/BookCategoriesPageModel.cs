...
namespace Scleam_Alexandra_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel

    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Scleam_Alexandra_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Scleam_Alexandra_Lab8Context context,
